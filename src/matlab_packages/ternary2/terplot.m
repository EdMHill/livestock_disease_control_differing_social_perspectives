...
% Make x-tick labels
for i=1:number
    htick(i,1)=text(l(i),-0.032,num2str(l(i)));
    htick(i,3)=text(1-l(i)*cos(pi/3)+0.025,l(i)*sin(pi/3)+0.015,num2str(l(i)));
    htick(i,2)=text(0.5-l(i)*cos(pi/3)-0.07,sin(pi/3)*(1-l(i)),num2str(l(i)));
end
